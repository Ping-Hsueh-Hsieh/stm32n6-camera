...
stedgeai generate --model deeplab_v3_mobilenetv2_05_16_256_asppv2_qdq_int8.onnx --target stm32n6 --st-neural-art default@user_neuralart_NUCLEO-N657X0-Q.json --input-data-type uint8 --output-data-type int8 --inputs-ch-position chlast --outputs-ch-position chlast
