...
#define LL_ATON_NETWORK_ORIGIN_MODEL_NAME   "yolov8n_boxnorm"
...
// Output buffer 1 -- Quantize_512_out_0
#define LL_ATON_NETWORK_OUT_1_ALIGNMENT   (32)
#define LL_ATON_NETWORK_OUT_1_SIZE_BYTES  (15876)
